...
public:
	...
	static void println(std::string str, int color);
	static void println(int number, int color);
	static void println(double number, int color);
	static void println(char str, int color);
	...
	static void print(std::string str, int color);
	static void print(int number, int color);
	static void print(double number, int color);
	static void print(char str, int color);
